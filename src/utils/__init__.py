"""
GPT-4 Categorizer package for Open-Ended Survey Responses

This package provides utilities designed for the processing of open-ended survey responses, categorizating them using GPT-4, and formatting the results. 
